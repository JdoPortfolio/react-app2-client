...
<span className="bg-pink-100 text-pink-800 text-lg font-medium me-2 px-2 py-4 ml-80 mr-80 rounded-full dark:bg-pink-900 dark:text-rose-500 flex flex-wrap items-center justify-center"> 🐾🐾🐾🐾  4.9 / 5 stars by 100+ customers</span>
