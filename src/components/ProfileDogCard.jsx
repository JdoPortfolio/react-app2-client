...
const ProfileDogCard = ({ dog, showButton, onDelete, onUpdate }) => {
  ...
  return (
    <div class="flex h-full w-full bg-pink-200 border-2 border-rose-400 rounded-xl xl:text-center xl:text-sm xl:flex-col xl:w-full tails-selected-element" contenteditable="true">
        ...
        <img src={photoURL} alt={`The ${dog.name}`} class="rounded-lg object-cover mt-3 mr-5 h-80 lg:h-96 md:flex-row md:mt-3 md:w-auto md:h-5/6 xl:bg-blend-difference xl:mt-3 xl:self-center xl:h-36 xl:w-56"/>
        ...
        <div>
          ...
          <button onClick={() => navigate(`/edit-dog/${dog.id}`)}>Edit Dog Details</button>
